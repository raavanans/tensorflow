...
class TFLiteKerasModelConverterV2(TFLiteConverterBaseV2):
  ...
  def _convert_keras_to_saved_model(self, output_dir):
    ...
    try:
      ...
      def _is_keras_3():
        """Returns true if the current version of Keras is 3.x.

        Note: This only detects the version of Keras that is currently
        installed. It does not detect the version of Keras of the model itself.
        """
        try:
