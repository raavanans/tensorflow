...
// and the HLO module is executed with
// ExecuteOptions::arguments_are_tupled = false.
// Additionally, we set ExecuteOptions::untuple_result = false unless
// the output is a tuple with leaves mixing host and device memory spaces,
// in which case PJRT mandates ExecuteOptions::untuple_result = true.
