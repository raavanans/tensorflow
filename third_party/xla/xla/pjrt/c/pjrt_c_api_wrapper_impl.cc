...
PJRT_Error* PJRT_Layouts_MemoryLayout_Serialize(
  ...
  PJRT_SerializedLayout* s_layout = new PJRT_SerializedLayout;
  if (s_layout == nullptr) {
    return new PJRT_Error{xla::ResourceExhausted(
        "Out of memory for `PJRT_Layouts_MemoryLayout_Serialize()`")};
  }
  s_layout->serialized = args->layout->layout->Serialize();
  ...
  args->serialized_layout_deleter =
      +[](PJRT_SerializedLayout* s_lay) { delete s_lay; };
  return nullptr;
}
